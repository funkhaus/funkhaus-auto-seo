 ...
 *
 * @return WP_error | int | bool Returns a WP-Error on network fail, or the ID of the attachment on success. False if nothing updated.
 */
 ...
 * @param string $filename The filename (without extension) that you want to rename to.
 */
