 ...
 *
 * @param $file_path string In the format of /www/wp-content/uploads/2020/11/example.png
 * @returns array | wp-error An array of the [$file_path, $file_url, $mime_type] or WP Error object
 */
