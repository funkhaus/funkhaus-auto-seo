...
function fh_seo_api_key_render()
{
    ...
    ?>
        <input type='password' class="input input-api-key regular-text code" name='fh_seo_settings[api_key]' value='<?php echo $options["api_key"] ?? ""; ?>'>
...
function fh_seo_options_page()
{
    ...
    <div id="page-fh-seo-options" class="wrap page-fh-seo-options">
        ...
        <div class="fh-seo-progress-status">
            ...
            <input type="button" data-total="<?php echo fh_seo_get_total_new_attachments(); ?>" id="start-regenerate" class="button button-primary" value="Start regeneration">
        </div>
